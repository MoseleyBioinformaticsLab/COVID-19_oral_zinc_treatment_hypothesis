...
* A second and related strain of SARSr-CoV is [severe acute respiratory syndrome coronavirus (SARS-CoV)](https://en.wikipedia.org/wiki/Severe_acute_respiratory_syndrome_coronavirus).
...
1. Micromolar levels of intracellular zinc inhibits the RNA-dependent RNA polymerase machinery of nidoviruses, which includes coronaviruses.
   * Te Velthuis, A.J., van den Worm, S.H., Sims, A.C., Baric, R.S., Snijder, E.J. and van Hemert, M.J., Zn2+ inhibits coronavirus and arterivirus RNA polymerase activity in vitro and zinc ionophores block the replication of these viruses in cell culture. PLoS Pathogens, 6(11) e100117 (2010).
      * https://dx.doi.org/10.1371%2Fjournal.ppat.1001176
      * Specifically, this paper demonstrates inhibition of RNA synthesis from the RNA-dependent RNA polymerase machinery in SARS-CoV infected Vero-E6 cells with 2 micromolar Zn2+ (from zinc acetate) and pyrithione, a zinc-ionophore.
      * Estimated CC50 (toxicity) is 82 micromolar pyrithione with 2 micromolar Zn2+ in Vero-E6 cells.
      * Estimated IC50 (inhibition) is 1.4 micromolar pyrithione with 2 micromolar Zn2+.
         * Estimated IC50 is 0.5 micromolar pyrithione with 2 micromolar Zn2+ for the equine arteritis virus.
   * SARS-CoV-2 RNA-dependent RNA polymerase
      * https://www.ncbi.nlm.nih.gov/protein/QHD43415/
      * BLAST results
...
2. Zinc is absorbed by oral mucosa cells.
   * Kapadia, J.M., Agarwal, A.R., Mishra, S., Joneja, P., Yusuf, A.S. and Choudhary, D.S., Cytotoxic and genotoxic effect on the buccal mucosa cells of patients undergoing fixed orthodontic treatment. J Contemp Dent Pract, 19(11), pp.1358-1362 (2018).
      * https://www.ncbi.nlm.nih.gov/pubmed/?term=PMID%3A30602641
      * This paper demonstrates absorption of zinc by buccal mucosa cells from orthodontic appliances.
3. Efficacy of zinc lozenges for treating common colds is supported by a meta-analysis of prior zinc lozenge studies.
   * Hemilä, H., Zinc lozenges and the common cold: a meta-analysis comparing zinc acetate and zinc gluconate, and the role of zinc dosage. JRSM open, 8(5), p.2054270417694291 (2017).
      ...
      * This meta-analysis determined the efficacy of zinc lozenges at greater than 80 mg zinc per day for reducing common cold duration on average by 33%.
      * Lozenges using zinc gluconate and zinc acetate demonstrated efficacy.
      * Daily dosage of 150 mg per day have few adverse effects.
4. SARS-CoV-2 enters cells via the ACE2 and TMPRSS2 receptors.
   * Hoffmann, M., Kleine-Weber, H., Krueger, N., Mueller, M.A., Drosten, C. and Pöhlmann, S., The novel coronavirus 2019 (2019-nCoV) uses the SARS-coronavirus receptor ACE2 and the cellular protease TMPRSS2 for entry into target cells. BioRxiv (2020).
      * https://doi.org/10.1101/2020.01.31.929042
   * Xu, X., Chen, P., Wang, J., Feng, J., Zhou, H., Li, X., Zhong, W. and Hao, P., Evolution of the novel coronavirus from the ongoing Wuhan outbreak and modeling of its spike protein for risk of human transmission. Science China Life Sciences, 63(3), pp.457-460 (2020).
      * https://doi.org/10.1007/s11427-020-1637-5
5. Oral mucosa expresses ACE2, a major viral receptor of SARS-CoV-2.
   * Xu, H., Zhong, L., Deng, J., Peng, J., Dan, H., Zeng, X., Li, T. and Chen, Q., High expression of ACE2 receptor of 2019-nCoV on the epithelial cells of oral mucosa. International Journal of Oral Science, 12(1), pp.1-5 (2020).
      * https://doi.org/10.1038/s41368-020-0074-x
      * This study utilized TCGA and FANTOM5 CAGE gene expression datasets for this analysis.
   * https://www.proteinatlas.org/ENSG00000130234-ACE2/tissue
      * The human protein atlas (HPA) shows the highest ACE2 expression in the gastrointestinal tract, utilizing a range of gene expression and protein expression datasets.
   * https://www.proteinatlas.org/ENSG00000184012-TMPRSS2/tissue
      * Likewise, HPA shows the highest TMPRSS2 gene expression and high protein expression in the gastrointestinal tract.
